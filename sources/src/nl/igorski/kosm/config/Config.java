...
public final class Config
{
    ...
    public static boolean canRecord()
    {
        ...
        final int requiredSize = BufferUtility.millisecondsToBuffer( RECORDING_FRAGMENT_SIZE, NativeAudioRenderer.SAMPLE_RATE ) * 2;

        // we append 2048 bytes as the written file is (measured @ 12 bytes) larger than the above calculation
        return FileSystem.hasSpaceFor(( requiredSize * NativeAudioRenderer.BYTES_PER_SAMPLE ) + 2048 );
    }
}
